...
MySQL - 5.7.24 : Database - tienda_online
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`tienda_online` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_bin */;
...
/*Data for the table `lineas_pedidos` */
...
(19,'Jhon','Granados','alexld26@gmail.com','$2y$04$wrW/gLFJxSXZzPuhMi2cYORkCOop7S65lzd7mmlsz5NWskZZ.6gje','user',NULL);

/* Trigger structure for table `lineas_pedidos` */

DELIMITER $$

/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `before_lineas_pedidos` */$$

/*!50003 CREATE */ /*!50003 TRIGGER `before_lineas_pedidos` BEFORE INSERT ON `lineas_pedidos` FOR EACH ROW UPDATE productos SET stock = stock - NEW.unidades WHERE productos.id = NEW.producto_id */$$
