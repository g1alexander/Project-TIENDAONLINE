...
-- Tiempo de generación: 25-05-2020 a las 22:26:03
...
--
-- Disparadores `lineas_pedidos`
--
DELIMITER $$
CREATE TRIGGER `before_lineas_pedidos` BEFORE INSERT ON `lineas_pedidos` FOR EACH ROW UPDATE productos SET stock = stock - NEW.unidades WHERE productos.id = NEW.producto_id
$$
DELIMITER ;
